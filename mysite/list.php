...
<form id="searchPost">
            <input type="text" name="search" id="searchField" placeholder="Search..." value="<?php if($error){ echo $_POST['postCode']; } ?>"/>
			<button id="submit">Search</button>
			</form>
			</div>
<form role="form" method="post" action="">
    <input type="text" name="title" placeholder="Title" value="<?php if($errors){ echo $_POST['title']; }?>">
    <input type="number" name="price" placeholder ="Price" value="<?php if($errors){ echo $_POST['price']; }?>">
    <input type="text" name="desc" placeholder ="Description" value="<?php if($errors){ echo $_POST['description']; }?>">
    <input type="text" name="postCode" id="postCode" readonly/>
    <input type="text" name="location" placeholder="Town/City" value="<?php if($errors){ echo $_POST['location']; }?>">
    <input type="text" name="street" id="street" placeholder="Street name" value="<?php if($errors){ echo $_POST['street']; }?>"/>
    <input type="number" name="beds" placeholder="# of bedrooms" value="<?php if($errors){ echo $_POST['beds']; }?>">
    <input type="number" name="baths" placeholder ="# of bathrooms" value="<?php if($errors){ echo $_POST['baths']; }?>">
    <input type="number" name="size" placeholder ="Size M2 if applicable" value="<?php if($errors){ echo $_POST['size']; }?>">
